...
3. Exception Handling: Provides mechanisms to handle runtime exceptions and errors
4. Managed Code vs. Unmanaged Code
5. Execution Process in CLR
6. Advantages of CLR
7. Performance Considerations
8. Best Practices

### Study Notes (Simplified)
- CLR executes managed code, enforces type safety, manages memory, and handles exceptions.
- IL is JIT-compiled to native code, enabling cross-language interoperability.
- Assemblies package metadata + IL and drive loading, security, and versioning behavior.
