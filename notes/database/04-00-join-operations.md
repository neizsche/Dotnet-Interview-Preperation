...
### Focus
- Core: Combining related data across tables with correct join semantics.
- Senior Depth: Join cardinality, null-extending joins, duplicate explosion, and performance planning.

### Topic Map
1. INNER JOIN
2. LEFT/RIGHT/FULL JOIN
3. CROSS and SELF JOIN
4. Join conditions
5. Many-to-many joins
6. Duplicate handling
7. Join performance basics

### Study Notes (Simplified)
- JOIN type changes returned rows, not just syntax style.
- Wrong join predicates can silently inflate results and metrics.
- Start with clear cardinality assumptions before writing joins.

### Rapid Interview Q&A
- Explain INNER vs LEFT JOIN with one dataset.
- Why do joins create duplicates unexpectedly?
- When should NATURAL JOIN be avoided?
