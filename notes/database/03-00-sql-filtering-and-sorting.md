...
### Focus
- Core: Filtering rows precisely and ordering results predictably.
- Senior Depth: Operator precedence, NULL logic, index-aware predicates, and stable pagination.
...
- Correct filtering is about semantics first, then performance.
- Predicate shape determines whether indexes can be used efficiently.
- Sorting must be deterministic for pagination and repeatable results.

### Rapid Interview Q&A
- What is operator precedence in SQL conditions?
- Why is `%term%` usually expensive?
- How do you build stable paginated sorting?
